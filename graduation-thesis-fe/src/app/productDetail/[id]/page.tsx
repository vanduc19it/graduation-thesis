    ...
    <>
      ...
      <div className={styles.detail}>
        ...
        <div className={styles.right}>
          ...
          <div style={{display:"flex",width:"36px", height:"36px",borderRadius:"50px",background:"rgba(0,0,0,0.1)", alignItems:"center", justifyContent:"center"}}>
              <AiOutlineMore  style={{color:"rgba(0, 0, 0, 0.7)", fontSize:"25px"}}/>
              </div>
          </div>
         
          <Text style={{ fontWeight: "500",marginBottom:"5px", marginTop:"10px" }}>
            Owned by <span style={{ color:"#ae4cff",  }}>{nft.owner.slice(0, 5)}...{nft.owner.slice(-5)}</span>
          </Text>
          ...
          <Tabs style={{border:"white"}}>
            <TabList>
              <Tab style={{ fontWeight: "500", fontSize: "16px", background:"black", borderRadius:"30px", color:"white", marginRight:"10px", boxShadow: "0 4px 8px 2px rgba(0, 0, 0, 0.1)" }}>
                Description
              </Tab>
              <Tab style={{ fontWeight: "500", fontSize: "16px", background:"#fff", borderRadius:"30px", color:"black", marginRight:"10px" , boxShadow: "0 4px 8px 2px rgba(0, 0, 0, 0.1)"}}>Reviews</Tab>
              <Tab style={{ fontWeight: "500", fontSize: "16px", background:"#fff", borderRadius:"30px", color:"black", boxShadow: "0 4px 8px 2px rgba(0, 0, 0, 0.1)" }}>Details</Tab>
            </TabList>
            <TabPanels>
              <TabPanel>
                <p style={{ textAlign: "justify" , padding:"20px", borderRadius:"20px", boxShadow: "0 0px 4px 2px rgba(0, 0, 0, 0.1)" }}>
