      ...
      <div className={styles.container}>
        ...
        >
          ...
          <div className={styles.card}>
            ...
            <Button style={{ borderRadius:"20px",background:"#ae4cff", color:"white", marginRight:"14px"}}>+ Follow</Button>
            </div>
